import
{
    Button, createStyles, Group, MantineProvider,
    Stack, Stepper
} from "@mantine/core";
...
export default function Form()
{
    ...
    const fomrValidateFn = useCallback((values: any) =>
    {
        const initValidate = {
            age:
        ...
        const hiddenField = {
            ...
            insulin: values.insulin === undefined ? "Please select one of the Yes or No" : null,
            mol: values.percentage
                ? null
                : !values.percentage && !values.mol ? 'This field is required' : null,
            percentage: values.mol
                ? null
                : !values.percentage && !values.mol ? "This field is required" : null,
            eGFRLeft: values.eGFRRight
                ? null
                : !values.eGFRLeft && !values.eGFRRight ? 'This field is required' : null,
            eGFRRight: values.eGFRLeft
                ? null
                : !values.eGFRLeft && !values.eGFRRight ? 'This field is required' : null,
        };

        if (showDiabetes) return { ...initValidate, ...hiddenField };
